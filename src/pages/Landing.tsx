  ...
  return (
    <>
      <Helmet>
        ...
        <meta property="og:description" content="Get a free solar quote for your home or business. Professional installation with PM Solar Scheme subsidies." />
        <meta property="og:image" content="https://aesolarsystems.in/og-image.jpg" />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="Get Free Solar Quote - AE Solar" />
        <meta name="twitter:description" content="Get a free solar quote and save up to 90% on electricity bills." />
      </Helmet>
    <div className="min-h-screen bg-gradient-to-br from-blue-900 via-blue-800 to-green-800 w-full overflow-x-hidden">
        ...
        <div className="w-full max-w-7xl mx-auto px-3 sm:px-4 lg:px-6 py-2 sm:py-3">
          <div className="flex items-center justify-between w-full">
            ...
            <div className="flex items-center flex-shrink-0 min-w-0">
              ...
              <h1 className="text-sm sm:text-base lg:text-lg font-bold text-white truncate">AE Solar</h1>
            </div>
      ...
      <footer className="bg-black/30 py-8 text-center text-gray-300 w-full">
        <div className="w-full max-w-4xl mx-auto px-3 sm:px-4 lg:px-6">
          <p>&copy; 2025 AE Solar Systems. All rights reserved.</p>
              ...
              <div className="relative h-24 bg-cover bg-center bg-no-repeat rounded-t-2xl" style={{
                ...
                <div className="relative z-10 p-4 sm:p-6 flex items-center justify-between">
                  <div className="flex items-center">
                    ...
                    <div>
                      <h2 className="text-lg sm:text-xl font-bold text-white">Contact AE Solar</h2>
